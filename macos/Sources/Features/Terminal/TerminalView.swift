...
struct DebugBuildWarningView: View {
    ...
    var body: some View {
        HStack {
            ...
            Text("You're running a debug build of Trident! Performance will be degraded.")
                .padding(.all, 8)
                .popover(isPresented: $isPopover, arrowEdge: .bottom) {
                    Text("""
                    Debug builds of Trident are very slow and you may experience
        ...
        .accessibilityValue("Debug builds of Trident are very slow and you may experience performance problems. Debug builds are only recommended during development.")
